...
## Analisis de sensibilidad de los parámetros del algoritmo de Naïve Bayes

Tras probar con distintos valores del parámetro de Laplace, nuestras observaciones concluyen que la mejor precisión en esta fase de nuestro proyecto se consigue con un _Laplace_ = 1.
